...
def test_execution_engine_works_with_robot_interface():
...
def test_execution_engine_works_with_robot_interface():
    ...
    # --------------------------------------------------------
    # Create a clean log file for this test
    # --------------------------------------------------------

    log_file = Path(
        "logs/test_robot_independent.json"
    )
...
def test_execution_engine_works_with_webots_adapter():
    ...
    log_file = Path(
        "logs/test_webots_execution.json"
    )

    # Delete old test log before starting
    if log_file.exists():
        log_file.unlink()
